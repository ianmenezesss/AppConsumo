...
const CongratulationsScreen = () => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.greenConsumerText}>Você é um consumidor verde responsável!</Text>

      {/* Substituir pela imagem anexada */}
      <Image 
        source={require('./arvore2(144px).png')} // Certifique-se de salvar a imagem no mesmo diretório ou ajuste o caminho
        style={styles.image} 
      />
