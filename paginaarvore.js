...
const CongratulationsScreen = () => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.greenConsumerText}>Você é um consumidor verde!</Text>

      {/* Substituir pela imagem anexada */}
      <Image 
        source={require('./arvore1(144px).png')} // Certifique-se de salvar a imagem no mesmo diretório ou ajuste o caminho
        style={styles.image} 
      />
